...
require_once 'FilesystemTestCase.php';

/**
 * Test class for ehough_filesystem_Filesystem.
 */
class ehough_filesystem_FilesystemTest extends ehough_filesystem_FilesystemTestCase
{
    ...
    {
        if (!class_exists('ehough_filesystem_fixtures_MockStream', false)) {

            require dirname(__FILE__) . '/fixtures/MockStream.php';
        }

        stream_wrapper_register('mock', 'ehough_filesystem_fixtures_MockStream');
