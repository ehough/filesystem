...
class ehough_filesystem_LockHandlerTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $lock = new ehough_filesystem_LockHandler('<?php echo "% hello word ! %" ?>');
    ...
    public function testLockRelease()
    {
        ...
        $l1 = new ehough_filesystem_LockHandler($name);
        $l2 = new ehough_filesystem_LockHandler($name);
    ...
    public function testLockTwice()
    {
        ...
        $lockHandler = new ehough_filesystem_LockHandler($name);
